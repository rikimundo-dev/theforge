...
| **WorkshopHelpModal** | Modal **Ayuda — TheForge** (Workshop): manual, **Integración Legacy ↔ Nuevo** (`apps/web/src/content/help/legacy-new-integration.md`), SDD y referencia por documento. |
