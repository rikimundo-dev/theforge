...
| **AgentsConfigCard** | Ajustes → **Agentes** → **Auditor**: select de instancia dedicada (`mddAuditorTenantInstanceId`). Opcional: `auditorChatModel` en el modal de la instancia. |
