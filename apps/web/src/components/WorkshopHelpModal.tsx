...
const SECTIONS: HelpSection[] = [
  {
    ...
    content: [
      ...
      "`Paso 0 → BRD → To-Be → MDD → Spec → Arq. → Casos → H.U. → Blueprint → Guía UX/UI → API → Flujos → Tasks → Infra`",
      "",
      ...
      "No ves MDD en la barra; el insumo es Paso 0 / Spec. Los entregables se limitan a Spec → API → Guía UX/UI → Tasks.",
      "",
      "**Legacy:**",
  ...
  },
  {
    ...
    content: [
      ...
      "| **Guía UX/UI** | Componentes visuales, paleta, espaciado, tokens de diseño |",
  ...
  },
  {
    ...
    content: [
      ...
      "## ¿Qué es en SDD?",
      "",
      "La **Guía UX/UI** estandariza la experiencia visual del producto. En formato **DESIGN.md**, define tokens de diseño (colores, tipografía, espaciado, elevación) y componentes visuales. En SDD, es la especificación que asegura que el frontend generado sea **visualmente coherente** sin depender de un diseñador en cada iteración.",
      "",
      "---",
      "",
      "## ¿Qué contiene?",
      ...
      "- Sin Guía UX/UI, el frontend generado usa defaults genéricos.",
    ].join("\n"),
  },
  {
    id: "api-contracts",
