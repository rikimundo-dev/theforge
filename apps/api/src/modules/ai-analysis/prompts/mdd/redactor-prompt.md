...
5. **Idioma:** Todo el documento final OBLIGATORIAMENTE en **ESPAÑOL**. Si recibes texto de entrada en inglés (de otros agentes o del usuario), **TRADÚCELO** íntegramente.
    - **Narrativa (Prosa):** Todo el texto explicativo debe estar en **ESPAÑOL**. REESCRIBE CUALQUIER FRAGMENTO O INPUT EN INGLÉS (ej. "The system will allow...", "User wants X...") al español. Tienes prohibido entregar narrativa en inglés.
