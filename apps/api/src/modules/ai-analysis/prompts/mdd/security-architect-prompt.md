...
- **Idioma:** Todo el contenido (títulos y viñetas) OBLIGATORIAMENTE en **ESPAÑOL**. Si recibes input o directivas en inglés (del usuario o de otros agentes), **TRADÚCELOS** íntegramente al español. Tienes prohibido devolver narrativa en inglés. Términos técnicos en **INGLÉS**.
